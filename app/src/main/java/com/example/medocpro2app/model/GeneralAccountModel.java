...
public class GeneralAccountModel implements Serializable {
    String id, under_group, gstin, reg_type, party_type, legal_name, acc_name, short_name, email, contact_name, mobile,
            pan_no, def_cre_per, mode, address1, address2, country, pincode, state, city, ProvideBankDetails,
            Enablecreditlimit, opening_bal, status, description, hsn_sac, gst_rate, nature_of_transaction,
            inc_val_cal, app_to, meth_of_calc, od_limit, item_type;
